...
public class CalcoloTariffa extends JFrame {//da rifare
	...
	public CalcoloTariffa(String username) {
		...
		codiceComboBox.setBounds(553, 71, 103, 22);
		getContentPane().add(codiceComboBox);
		
		

		JComboBox<String> comboBox_1 =new JComboBox<String>();
		comboBox_1.setBounds(553, 127, 103, 22);
		getContentPane().add(comboBox_1);
		//COMBO BOX
		
		JComboBox<String> comboBox_2 =new JComboBox<String>();
		comboBox_2.setBounds(553, 200, 103, 22);
...
if(entrata.equals("")||uscita.equals("")||textField.getText().equals("")) {
	JOptionPane.showMessageDialog(null, "Seleziona i caselli di entrata e uscita e acqusire la targa del veicolo");}else {
